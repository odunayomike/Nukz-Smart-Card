        ...
        <form action="" method="POST">
            <div class="qrcode-basic-info">
                ...
                <div style="margin-bottom: 40px;" class="qrcode-form">
                    <label style="padding: 15px 30px 15px 30px;" for="">Youtube URL</label>
                    <input style="width: 300px;" type="text" name="qrcode"
                        placeholder="https://www.youtube.com/your_video_url" required>
                </div>
            </div>
