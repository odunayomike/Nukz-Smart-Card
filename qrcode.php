...
<div class="qrcode-link">
    <div class="qrcode-first-section">
        <h2 style="padding: 30px 50px 30px 50px;">QR Code Generator</h2>
        <form action="" method="POST">
            <div class="qrcode-basic-info">
                <h2>Basic Information</h2>
                <div style="margin-bottom: 40px;" class="qrcode-form">
                    <label style="padding: 15px 30px 15px 30px;" for="">URL or Link</label>
                    <input type="text" name="qrcode" placeholder="https://www.nukreationzdigital.com" required>
                </div>
            </div>
