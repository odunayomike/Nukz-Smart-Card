...
<div class="qrcode-link">
    <div class="qrcode-first-section">
        <h2 style="padding: 30px 50px 30px 50px;">QR Code Generator for Your Resume</h2>
        <form action="" method="POST">
            <div class="qrcode-basic-info">
                <h2>Basic Information</h2>
                <div style="margin-bottom: 40px;" class="qrcode-form">
                    <label style="padding: 15px 30px 15px 30px;" for="">Resume URL</label>
                    <input style="width: 300px;" type="text" name="qrcode" placeholder="https://www.yourresume_url"
                        required>
                </div>
            </div>
            <div class="qrcode-footer">

                <button class="save-qr-code"
                    style="padding: 10px 50px 10px 50px; width: 100%; border: none; background: #FF8B3B; border-radius: 5px; color: #fff;"
                    name="qrcode-btn" type="submit"> Save QR Code <i class="bi bi-chevron-right"></i> </button>
