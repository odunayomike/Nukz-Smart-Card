    ...
    <div class="navbar" style="display: flex; justify-content: space-evenly;">
        <div class="nav" id="myHeader">
            ...
            <div style="text-align: center; margin-left: 100px; justify-content: center; display: flex;"
                class="nav-text">
                <a class="<?php if($currentPage =='home'){echo 'active';}?>" href="index.php">HOME</a>
                <!-- <a href="">ABOUT US</a> -->
                <a class="<?php if($currentPage =='createCard'){echo 'active';}?>" href="card_details.php">CREATE
                    CARD</a>
                <a class="<?php if($currentPage =='cardDetails'){echo 'active';}?>" href="card_details_view2.php">CARD
                    DETAILS</a>
                <a class="<?php if($currentPage =='tools'){echo 'active';}?>" href="tools.php">TOOLS</a>
                <a class="<?php if($currentPage =='wallet'){echo 'active';}?>" href="wallet.php">WALLET</a>
            ...
            <div style="display: flex; margin-left: 100px;" id="login-user-button" class="">
                ...
                <img class="img" style="width: 50px; cursor: pointer; height: 50px; margin-top: px; border-radius: 50%; background: #D9D9D9;
                        box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.12); padding: 8px;" src="./admin/img/user-img.png"
                    alt="nukreationz" ">
        ...
        <div class="mobile-menu-list" style="display: none;">
            <ul class="">
                ...
                <!-- <a href="">ABOUT US</a> -->
                <li><a class="<?php if($currentPage =='createCard'){echo 'active';}?>" href="card_details.php">CREATE
                        CARD</a></li><br>
                <li><a href="<?php if($currentPage == 'cardDetails'){echo 'active';}?>card_details_view2.php">CARD
                        DETAILS</a></li><br>
